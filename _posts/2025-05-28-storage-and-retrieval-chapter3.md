...
* [3장 저장소와 검색](#3장-저장소와-검색)
  ...
  * [트랜잭션 처리나 분석?](#트랜잭션-처리나-분석)
    * [데이터 웨어하우징](#데이터-웨어하우징)
    * [분석용 스키마: 별 모양 스키마와 눈꽃송이 모양 스키마](#분석용-스키마-별-모양-스키마와-눈꽃송이-모양-스키마)
  * [칼럼 지향 저장소](#칼럼-지향-저장소)
    * [칼럼 압축](#칼럼-압축)
    * [칼럼 저장소의 순서 정렬](#칼럼-저장소의-순서-정렬)
    * [칼럼 지향 저장소에 쓰기](#칼럼-지향-저장소에-쓰기)
    * [집계: 데이터 큐브와 구체화 뷰](#집계-데이터-큐브와-구체화-뷰)
<!-- TOC -->
...
애플리케이션 개발자가 이를 알아야하는 이유가 무엇일까? 대 애플리케이션 개발자가 처음부터 저장소 엔진을 구현하기보다는
